        ...
        <div class="container">
            ...
            <div class="col-12 col-md-12">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            <h2 class="h4 text-center title-header-register" data-aos="fade-left" data-aos-duration="20000">ĐĂNG NHẬP</h2>
                            <h3 class="fs-6 fw-normal text-secondary text-center m-0" data-aos="fade-left" data-aos-duration="20000">Nhập thông tin đăng nhập</h3>
                            </div>
                        </div>
                    </div>
                    <form action="#!">
                    <div class="row gy-3 overflow-hidden">
                        ...
                        <div class="col-12">
                            <div class="d-grid" data-aos="fade-left" data-aos-duration="20000">
                                <button class="btn btn-register bsb-btn-xl btn-primary" type="submit">Đăng nhập</button>
                            </div>
                        </div>
                    </div>
                    </form>
